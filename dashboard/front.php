  ...
  <div class="col-lg-12 text-center">
    ...
    <div class="col-lg-12 m-auto">
        <div class="col-lg-12 text-left py-3">
          ...
          <div class="row"> 
            <div class="col-lg-12">
    <a href="front_add.php"> <button type="button" class="btn btn-primary">Add Font</button> </a>
  </div>
          </div>
          <hr>
        </div>
        <table class="table table-striped" id="table_id">
          ...
          <tr class="">
            ...
            <span>
             <td><a href="front_edit.php?id=<?php echo  $value['id']; ?>" class="btn btn-primary">Edit</a></td>
              <td><a href="front_del.php?id=<?php echo  $value['id']; ?>" class="btn btn-danger">Delete</a></td>
              </span>
