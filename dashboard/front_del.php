...
$select_photo = "SELECT photo FROM font_pic WHERE id=$user_id";

$del_photo_query = mysqli_query($db_connection,$select_photo);
$after_assoc = mysqli_fetch_assoc($del_photo_query);

$delete_from_location = "uploads/font/".$after_assoc['photo'];
unlink($delete_from_location);


$del_query = "DELETE FROM font_pic WHERE id=$user_id";
