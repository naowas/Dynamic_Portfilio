...
$uploaded_file = $_FILES['about_img2'];
...
if(in_array($extention, $allowed_extention)){
  if($uploaded_file['size'] <= 20000000){
    ...
    $insert = "INSERT INTO about (header,para1,para2) VALUES ('$about_title','$choose_3', '$choose_4')";
    ...
    $update = "UPDATE about SET about_img='$file_name' WHERE id=$last_id";
